...
import com.tacademy.penthouse.MDRoomAdapter.OnAdapterItemClickListener;
...
public class UserRoomAdapter  extends BaseExpandableListAdapter implements MDItemView.OnItemDataClickListener{

	Context mContext;
	ArrayList<RoomData> items = new ArrayList<RoomData>();
	int userResId = R.drawable.ic_launcher;
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		v.setData(items.get(groupPosition), userResId);
		return v;
	}
	@Override
